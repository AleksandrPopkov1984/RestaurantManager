...
public class UserTestData {
    ...
    public static final User user1 = new User(USER1_ID, "Vasiljev", "Igor", "i_vasiljev@gmail.com", "admin", Role.ADMIN, Role.USER);
    ...
    public static final UserToWithFullData userToWithFullData1 = new UserToWithFullData(USER1_ID, "Vasiljev", "Igor",
            "i_vasiljev@gmail.com", "admin", true, null, new HashSet<>(Arrays.asList(Role.ADMIN, Role.USER)));
